odoo.define('smart_custom_report.item_sales_return', function(require) {
    'use strict';
    ...
    var ItemSalesReturn = AbstractAction.extend({
       template: 'ItemSalesReturn',
       events: {
  ...
  start: function() {
   ...
   $("head").append("<link href='/smart_custom_report/static/src/css/tabulator.css' type='text/css' rel='stylesheet'/>");
    ...
    rpc.query({
       model: 'dynamic.item.sales.return',
       method: 'create',
       args: [{
       }]
    }).then(function(res) {
  ...
  load_data: function(initial_render = true) {
          ...
          self._rpc({
            ...
            if (datas['orders']){
               self.$('.table_view_pr').html(QWeb.render('ItemSalesReturnOrderTable', {
             ...
             if (initial_render) {
                self.$('.filter_view_pr').html(QWeb.render('ItemSalesReturnFilterView', {
  ...
  core.action_registry.add("i_s_r", ItemSalesReturn);
    return ItemSalesReturn;
  });