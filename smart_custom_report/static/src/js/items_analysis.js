odoo.define("smart_custom_report.items_analysis", function(require){
       ...
       var time = require('web.time');
        ...
        var ItemsAnalysis = AbstractAction.extend({
            template: 'ItemsAnalysis',
            events: {
       ...
       load_data: function(initial_render = true) {
               ...
               self._rpc({
                 ...
                 if (datas['orders']){
                    self.$('.table_view_pr').html(QWeb.render('ItemsAnalysisOrderTable', {
                  ...
                  if (initial_render) {
                     self.$('.filter_view_pr').html(QWeb.render('ItemsAnalysisFilterView', {
        ...
        print_pdf: function(e) {
               ...
               return $("#table2excel").table2excel({
                   ...
                   exclude: ".noExl",
                   name: "تقرير مشتريات",
                   filename: "Items Analysis", //do not include extension
        ...
        [false, 'list'],
         ...
         core.action_registry.add("i_a_r", ItemsAnalysis);
