...
class DynamicPurchaseInvoiceReturn(models.Model):

    _name = 'dynamic.purchase.invoice.return'
    ...
    def purchase_report(self, option):
        report_values = self.env['dynamic.purchase.invoice.return'].search([('id', '=', option[0])])
        data = {'model': self}
    ...
    def get_filter_data(self, option):
        r = self.env['dynamic.purchase.invoice.return'].search([('id', '=',option[0])])
        default_filters = {}
        filter_dict = {}
        return filter_dict
