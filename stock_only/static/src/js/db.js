            ...
            for (var i = 0, len = qunats.length; i < len; i++) {
                ...
                if (qunat.product_id in this.quant_by_product_id) {
                    ...
                    if (qunat.location_id in tmp_loc_dic) {
                        ...
                        tmp_loc_dic[qunat.location_id] = qunat.quantity + tmp_qty;
                    } else {
                        tmp_loc_dic[qunat.location_id] = qunat.quantity;
                    }
                    this.quant_by_product_id[qunat.product_id] = tmp_loc_dic;
                } else {
                    var location_qty_dic = {};
                    location_qty_dic[qunat.location_id] = qunat.quantity;
                    this.quant_by_product_id[qunat.product_id] = location_qty_dic;
                }
            }
        },
