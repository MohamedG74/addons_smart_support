...
class PosOrder(models.Model):
    ...
    @api.model
    def get_o_lines(self,order):
        return self.env['pos.order.line'].search_read([('order_id', 'in', order_ids)])
    @api.model
...
class HrEmployee(models.Model):
    ...
    sh_employee_discount = fields.Float(string="Maximum Discount % (Discount Limit)",default="100")
...
class PosConfig(models.Model):
    ...
    sh_enable_order_list = fields.Boolean(string="Enable Order List",default=True)
    sh_load_order_by = fields.Selection(
        [('all', 'All'), ('session_wise', 'Session Wise'), ('day_wise', 'Day Wise')], string="Load Order By", default='session_wise', required="1")
