...
class ResConfigSettiongsInhert(models.TransientModel):
    ...
    sh_return_days = fields.Integer(
        related="pos_config_id.sh_return_days", readonly=False)
    sh_allow_return = fields.Boolean(
        related="pos_config_id.sh_allow_return", readonly=False)
    sh_branch_discount = fields.Float(
        related="pos_config_id.sh_branch_discount", readonly=False)
