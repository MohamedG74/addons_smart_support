odoo.define('smart_custom_report.item_balance', function(require) {
    'use strict';
    ...
    var ItemBalance = AbstractAction.extend({
       template: 'ItemBalance',
       events: {
  ...
  load_data: function(initial_render = true) {
          ...
          self._rpc({
            ...
            if (datas['orders']){
               self.$('.table_view_pr').html(QWeb.render('ItemBalanceOrderTable', {
             ...
             if (initial_render) {
                self.$('.filter_view_pr').html(QWeb.render('ItemBalanceFilterView', {
       ...
       groupButton: function (event) {
         ...
         if (!table) {
             ...
             table = new Tabulator("#table2excel", {
               ...
               movableRows: true,
                 columns: [
                     { title: "المجموعة الرئيسية", field: "parent_category_name", widthGrow:1 },
   ...
   print_pdf: function(e) {
          ...
          return $("#table2excel").table2excel({
              ...
              filename: "Report Item Balance", //do not include extension
  ...
  core.action_registry.add("i_b", ItemBalance);
    return ItemBalance;
  });