odoo.define('smart_custom_report.item_sales_employee', function(require) {
   'use strict';
   ...
   var ItemSalesEmployee = AbstractAction.extend({
      template: 'ItemSalesEmployee',
      events: {
 ...
 load_data: function(initial_render = true) {
         ...
         self._rpc({
           ...
           if (datas['orders']){
              self.$('.table_view_pr').html(QWeb.render('ItemSalesEmployeeOrderTable', {
            ...
            if (initial_render) {
               self.$('.filter_view_pr').html(QWeb.render('ItemSalesEmployeeFilterView', {
     ...
     groupButton: function (event) {
        ...
        exportButton.addEventListener("click", function downloadOnce() {
           table.download("xlsx", "تقرير مبيعات و مرتجعات الاصناف.xlsx", {sheetName: "Item Sales Returns"});
  ...
  print_pdf: function(e) {
         ...
         return $("#table2excel").table2excel({
             ...
             filename: "Item Sales Employee", //do not include extension
 ...
 core.action_registry.add("i_t_e", ItemSalesEmployee);
   return ItemSalesEmployee;
 });