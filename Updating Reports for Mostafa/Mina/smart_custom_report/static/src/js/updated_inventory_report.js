odoo.define('smart_custom_report.updated_inventory_report', function(require) {
   'use strict';
   ...
   var UpdatedInventoryReport = AbstractAction.extend({
      template: 'UpdatedInventoryReport',
      events: {
 ...
 start: function() {
  ...
  $("head").append("<link href='/smart_custom_report/static/src/css/tabulator.css' type='text/css' rel='stylesheet'/>");
   ...
   rpc.query({
      model: 'dynamic.updated.inventory.report',
      method: 'create',
      args: [{
      }]
   }).then(function(res) {
 ...
 load_data: function(initial_render = true) {
         ...
         self._rpc({
           ...
           if (datas['orders']){
              self.$('.table_view_pr').html(QWeb.render('UpdatedInventoryOrderTable', {
            ...
            if (initial_render) {
               self.$('.filter_view_pr').html(QWeb.render('UpdatedInventoryFilterView', {
  ...
  print_pdf: function(e) {
         ...
         return $("#table2excel").table2excel({
             ...
             filename: "Updated Inventory Report", //do not include extension
 ...
 core.action_registry.add("u_i_r", UpdatedInventoryReport);
   return UpdatedInventoryReport;
 });