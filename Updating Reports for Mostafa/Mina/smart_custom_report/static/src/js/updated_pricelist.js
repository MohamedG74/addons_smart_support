odoo.define('smart_custom_report.pricelist_updated_report', function(require) {
    'use strict';
   ...
   [false, 'list'],
       ...
       apply_filter: function() {
               ...
               if (this.$el.find('.datetimepicker-input[name="date_from"]').val()) {
                  ...
                  if (moment(selectedDateFrom).isBefore("2023-1-1")) {
                     alert("تاريخ البداية خطأ (يجب ادخال تاريخ بعد 1-1-2023)");
                     return;
                  }
