odoo.define('smart_custom_report.suggested_order', function(require) {
   'use strict';
   ...
   var SuggestedOrderReport = AbstractAction.extend({
      template: 'SuggestedOrderReport',
      events: {
 ...
 load_data: function(initial_render = true) {
         ...
         self._rpc({
           ...
           if (datas['orders']){
              self.$('.table_view_pr').html(QWeb.render('SuggestedOrderOrderTable', {
            ...
            if (initial_render) {
               self.$('.filter_view_pr').html(QWeb.render('SuggestedOrderFilterView', {
  ...
  print_pdf: function(e) {
         ...
         return $("#table2excel").table2excel({
             ...
             exclude: ".noExl",
             name: "تقرير التغذية",
             filename: "Suggested Order Report", //do not include extension
 ...
 core.action_registry.add("s_o_r", SuggestedOrderReport);
   return SuggestedOrderReport;
 });