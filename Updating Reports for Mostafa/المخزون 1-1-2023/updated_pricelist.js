odoo.define('smart_custom_report.updated_pricelist', function(require) {
    'use strict';
    ...
    var UpdatedPricelist = AbstractAction.extend({
       template: 'UpdatedPricelist',
       events: {
  ...
  start: function() {
   ...
   $("head").append("<link href='/smart_custom_report/static/src/css/tabulator.css' type='text/css' rel='stylesheet'/>");
    ...
    rpc.query({
       model: 'dynamic.pricelist.updated.report',
       method: 'create',
       args: [{
       }]
    }).then(function(res) {
  ...
  load_data: function(initial_render = true) {
          ...
          self._rpc({
            ...
            if (datas['orders']){
               self.$('.table_view_pr').html(QWeb.render('PricelistOrderTable', {
             ...
             if (initial_render) {
                self.$('.filter_view_pr').html(QWeb.render('PricelistFilterView', {
  ...
  core.action_registry.add("pl_u_r", UpdatedPricelist);
