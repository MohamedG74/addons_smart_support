...
class StockMoveLine(models.Model):
	...
	@api.depends('product_id','product_id.uom_id','move_id','qty_done','product_id.secondary_uom_id')
	def secondary_qty_compute(self):
		for move_line in self:
			if move_line.product_id.is_secondary_uom:
				...
				uom_quantity = move_line.product_id.uom_id._compute_quantity(move_line.move_id.product_uom_qty or move_line.qty_done, move_line.product_id.secondary_uom_id, rounding_method='HALF-UP')
