...
class ShProductTemplate(models.Model):
    ...
    sh_secondary_uom = fields.Many2one('uom.uom', 'Secondary Selling Unit')
    ...
    company_notes = fields.Char(
        "Product Notes"
    )
    second_price = fields.Monetary("Second Unit Price")
    sh_is_secondary_unit = fields.Boolean("Enable Second Unit ?")
