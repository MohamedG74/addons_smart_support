...
class StockPicking(models.Model):
    ...
    def _compute_show_validate(self):
        for picking in self:
            ...
            if(picking.show_validate == True and picking.picking_type_id.code == "outgoing"):                
            ...
            if (
                ...
                raise UserError(
                    _(
                        ...
                        "and in the Branch must be the same."
                    )
                )
    ...
    def _check_picking_type_operating_unit(self):
        for rec in self:
            ...
            if (
                ...
                raise UserError(
                    _(
                        "Configuration error. The Branch of the picking "
